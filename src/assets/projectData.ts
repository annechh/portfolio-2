...
export const projectData = {
  secondYear: [
    ...
    Holidaze description `,
      shortDescription: 'Second year Project Exam',
      icons: {
        url: HOLIDAZE_Icon,
        alt: 'Holidaze icon',
      },
...

    {
      ...
      shortDescription: 'JS Frameworks course assignment',
      icons: {
        url: HOLIDAZE_Icon,
        alt: 'Holidaze icon',
      },
      ...
      githubLink: {
        link: 'https://github.com/annechh/ca-js-frameworks',
      },
      liveDemo: {
        link: 'https://lazysales.netlify.app/',
      },
    },

    {
      ...
      shortDescription: 'Second year Semester Project',
      icons: {
        url: BM_Icon,
        alt: 'Bid Me icon',
      },
  ...
  firstYear: [
    {
      ...
      shortDescription: 'First year Project Exam',
      icons: {
        url: SA_Icon,
...

    {
      ...
      shortDescription: 'First year Semester Project',
      icons: {
        url: SSM_Icon,
...

    {
      ...
      shortDescription: 'First year HTML and CSS assignment',
      icons: {
        url: SE_Icon,
