...
//     >
//       {project ? (
//         <div className="max-w-[1000px] w-full flex flex-col p-6 lg:p-10">
//           <div className="flex flex-col md:flex-row justify-center md:justify-between gap-5">
//             <div className="flex-1/2">
//               <div className="flex flex-col justify-between h-full gap-5">
//                 <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold tracking-widest">
...
//           <div className="flex flex-col gap-10">
//             <div className="flex flex-col gap-10">
//               <div className="flex flex-col gap-1 bg-dark p-5">
//                 <h2 className="text-xl font-bold">{project.title}</h2>
//                 <p className="px-3">{project.description}</p>
//               </div>

//               <div className="flex flex-col gap-2 bg-dark shadow-sm shadow-sun/20 p-5">
//                 {project.feedback && (
//                   <div className="flex flex-col gap-1">
//                     <h2 className="text-xl font-bold">Feedback</h2>
//                     <p className="px-3">{project.feedback}</p>
